...
def process(
    ...
    #
    # Used ONLY for subtle recovery in genuine deep shadows.
    # ======================================================

    w_over = (
        0.02 +
        0.50 * shadow_recovery_mask +
        0.20 * q_over *
        shadow_recovery_mask
    )
    # ======================================================
    ...
    # No post-fusion brightness anchoring.
    # Exposure changes must come only from the blending weights.
...
# Midtone improvement disabled.
# Client requirement:
# brightness and shadow changes must come only from
# the Under / Normal / Over exposure blending weights.
...
# ======================================================
# Disabled.
# Client requires the final result to come only from
# adaptive exposure blending, without artificial local
# brightness or shadow modification.
