...
def main():
    ...
    input_dir = "/home/prthick/FreeMEF/my_test/scene005"
    # ----------------------------------------------
    # OUTPUT DIRECTORY
    # ----------------------------------------------
    ...
    # ==============================================
    # V3.7 — CONTROLLED EXPOSURE CONTRIBUTION
    #
    # Keep NORMAL exposure dominant.
    # Under/Over are used only for real recovery.
    # ==============================================

    # UNDER:
    # Reduced influence to prevent local dark patches
    # and over-aggressive highlight replacement.
    w_under = (
        0.05 +
        1.20 * highlight_mask +
        0.30 * q_under
    ...
    # NORMAL IMAGE WEIGHT
    #
    # PRIMARY EXPOSURE / COLOR / WB ANCHOR
    # ==============================================
    ...
    # ==============================================
    # OVER:
    # Only controlled shadow recovery.
    # Prevents lifted shadows and bright patches.
    # ==============================================

    w_over = (
        0.02 +
        0.90 * shadow_recovery_mask +
        0.35 * q_over
    )
    # ==============================================
